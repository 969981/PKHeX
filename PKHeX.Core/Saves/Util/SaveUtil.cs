...
public static class SaveUtil
{
    ...
    // Bank Binaries
    public const int SIZE_G7BANK = Bank7V15Layout.LegacySize;
    public const int SIZE_G7BANK_V15 = Bank7V15Layout.FullSize;
    public const int SIZE_G7BANK_OBJECT = Bank7V15Layout.ObjectDumpSize;
    ...
    private static bool IsSizeCommonFixed(int length) => length is
        ...
        or SIZE_G2RAW_U
        or SIZE_G7BANK or SIZE_G7BANK_V15 or SIZE_G7BANK_OBJECT or SIZE_G4BANK or SIZE_G4RANCH or SIZE_G4RANCH_PLAT;
    ...
    private static bool IsBank7(ReadOnlySpan<byte> data) => Bank7V15Layout.TryIdentify(data, out _);
